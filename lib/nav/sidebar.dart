...
import 'package:to_pay_app/nav/nav.dart';
...
class _homeWithSidebarState extends State<homeWithSidebar> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    // rotationController = AnimationController(duration: Duration(milliseconds: 200), value: 1);
    // super.initState();
  }
  @override
  Widget build(BuildContext context) {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("John Matanda", style: TextStyle(
                                color: Colors.white,
                                fontSize: 19,
                                fontWeight: FontWeight.w700,
                                fontFamily: "ubuntu"
                              ),),
                              Text("Borås", style: TextStyle(
                                fontSize: 13,
    ...
    return Row(
      children: [
        ...
        Text(name, style: TextStyle(
          fontSize: 16,
          fontWeight: (isSelected) ? FontWeight.w700: FontWeight.w400,fontFamily: "avenir", color: Colors.white
        ),)
      ],
    );
  }
