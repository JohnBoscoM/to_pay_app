...
class MissedPaymentsPage extends StatefulWidget {
  @override
  _MissedPaymentsPageState createState() => _MissedPaymentsPageState();
}

class _MissedPaymentsPageState extends State<MissedPaymentsPage> {
          ...
          child: Container(
            child: Column(
              children: <Widget>[
                  ...
                  child: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage("assets/images/hugo-MissedBills.png"), alignment: Alignment.centerRight),
